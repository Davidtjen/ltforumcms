...
class ContactFormController extends Controller
{
    ...
    {
        // Validate request data and store in variable
        ...
        // Send an answer to message sender
        // Mail::to($senderEmail)->send(new ContactFormMail($data));

        // Send success popup after above is complete
