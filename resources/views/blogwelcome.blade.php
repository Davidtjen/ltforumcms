...
<header class="header text-center text-white"
    style="background-image: linear-gradient(to bottom, rgba(245, 246, 252, 0.52), rgba(117, 19, 93, 0.73)),url({{ asset('/img/bg/1.jpg')}})">
                        ...
                        <div class="col-md-6">
                            <div class="card border hover-shadow-6 mb-6 d-block">
                                <a href="{{ route('blog.show', $post->id) }}">
                                    <img class="card-img-top" style="height: 240px; width: 450px;"
                                        src="{{ asset('storage/'. $post->image) }}" alt="Card image cap">
                                </a>
